...
def parse_arguments():
    ...
    parser.add_argument('-g', '--get-tickets', required=True, choices=['mine', 'group'], help='\nTells the script which set of tickets to retrieve.')
...
# Modify your main function to include a call to get_my_tickets
def main():
    ...
    # Fetch and sort tickets based on the specified option
    ...
    # Display sorted tickets based on the selected output format
    if args.output == 'json':
        display_as_json(sorted_tickets)
    elif args.output == 'table':
        display_as_table(sorted_tickets)
